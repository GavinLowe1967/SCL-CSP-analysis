...
%% \end{figwindow}
%% The table to the right gives statistics about the times taken to perform these
%% checks, in the failures-divergences model, for different numbers of threads
%% (in each case, using two data values).
%% \end{minipage}
%% %
%% \quad
%% \begin{tabular}{@{}crr@{}}
